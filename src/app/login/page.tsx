      ...
      <div className="w-full max-w-md">
        ...
        {urlError === "OAuthAccountNotLinked" && (
          <div className="mb-4 rounded-xl border border-orange-200 bg-orange-50 p-4 text-sm text-orange-800">
            <p className="mb-1 font-semibold">Účet již existuje</p>
            <p>
              Na tento email již existuje účet přihlášený přes jiného
              poskytovatele.
            </p>
          </div>
        )}
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mb-6 flex flex-col gap-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
