...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className={`rounded-2xl p-6 shadow-lg ${styles.container}`}>
      <h3
        className={`mb-2 text-xs font-medium tracking-wider uppercase ${styles.title}`}
      >
        {title}
      </h3>
      <div
        className={`text-2xl font-bold tracking-tight md:text-3xl ${isLoading ? "animate-pulse" : ""}`}
      >
