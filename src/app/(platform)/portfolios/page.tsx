...
export default function PortfoliosPage() {
  ...
  const handleDelete = (e: React.MouseEvent, id: string) => {
    e.preventDefault(); // Zabrání prokliknutí na detail portfolia
  ...
  return (
    <div className="mx-auto max-w-7xl p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Moje Portfolia</h1>
              ...
              >
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Vytvořeno {portfolio.createdAt.toLocaleDateString("cs-CZ")}
                  </p>
                </div>

                <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4">
                  <span className="text-xs font-semibold tracking-wider text-slate-500 uppercase">
                    {portfolio._count.transactions} Transakcí
                  </span>
